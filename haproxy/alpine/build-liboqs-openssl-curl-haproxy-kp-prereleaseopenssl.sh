...
git clone --single-branch --branch master https://github.com/open-quantum-safe/liboqs  && cd liboqs && git checkout f6ca3dca5e95e77267dd0d7f5480c512cd6a4d6d && cd ..
git clone --single-branch --branch OQS-OpenSSL_1_1_1-stable https://github.com/open-quantum-safe/openssl && cd openssl && git checkout 235b7ba0364276b4e77390cf9992063e1b654e3c && cd ..
...
LDFLAGS="-Wl,-rpath -Wl,$INSTALLDIR/lib" ./Configure linux-x86_64 -DOQS_DEFAULT_GROUPS=\"X25519:p384_kyber768:kyber768\" -lm --prefix=$INSTALLDIR && make && make install
